...
<?php echo $this->Form->create('Turma'); ?>
	<fieldset>
		<legend><?php echo __('Edit Turma'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Turma.disciplina_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Turma.disciplina_id'))); ?></li>
