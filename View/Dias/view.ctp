...
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Editar Dia'), array('action' => 'edit', $dia['Dia']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Excluir Dia'), array('action' => 'delete', $dia['Dia']['id']), null, __('Are you sure you want to delete # %s?', $dia['Dia']['id'])); ?> </li>
...
<div class="related">
	<h3><?php echo __('Horários Relacionados'); ?></h3>
