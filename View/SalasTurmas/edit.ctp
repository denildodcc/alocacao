...
<?php echo $this->Form->create('SalasTurma'); ?>
	<fieldset>
		<legend><?php echo __('Edit Salas Turma'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SalasTurma.sala_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('SalasTurma.sala_id'))); ?></li>
