<div class="professors index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('Visualizar'), array('action' => 'view', $professor['Professor']['id'])); ?>
			<?php echo $this->Html->link(__('Editar'), array('action' => 'edit', $professor['Professor']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $professor['Professor']['id']), null, __('Tem certeza que deseja excluir o registro de id  # %s?', $professor['Professor']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
