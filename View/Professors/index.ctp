<div class="professors index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $professor['Professor']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $professor['Professor']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $professor['Professor']['id']), null, __('Are you sure you want to delete # %s?', $professor['Professor']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
