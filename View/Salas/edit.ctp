...
<?php echo $this->Form->create('Sala'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sala'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Sala.predio_id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Sala.predio_id'))); ?></li>
