<div class="horas index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $hora['Hora']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $hora['Hora']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $hora['Hora']['id']), null, __('Are you sure you want to delete # %s?', $hora['Hora']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
